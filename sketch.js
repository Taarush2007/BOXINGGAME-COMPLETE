...
if(score1 >= 201 && score2 < 200 ){
gameState = 3;
score1 = 200;
winner = "player1";
}

if(score2 >= 201 && score1 < 200 ){
  gameState = 3;
  winner = "player2";
  }
...
if(gameState === 3){
  ...
  if(winner === "player1")
{
  player1.addImage(redwinner);
  player1.x = 650;
  player1.scale = 0.6;
  beltsprite.visible = false;
  player2.visible = false;
  fill("WHITE");
  text("PLAYER1 Wins",550,100);
}

if(winner === "player2")
{
  player2.addImage(bluewinner);
  player2.x = 650;
  player2.scale = 0.6;
  beltsprite.visible = false;
  player1.visible = false;
  fill("WHITE");
  text("PLAYER2 Wins",550,100);
}
